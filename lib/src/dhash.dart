...
//   final rowDiff = imageRowMat
//       .rowRange(1, 9)
//       .addMat(imageRowMat.rowRange(0, 8).multiplyF32(-1.0));
//   final colDiff = imageColMat
//       .colRange(1, 9)
//       .addMat(imageColMat.colRange(0, 8).multiplyF32(-1.0));
//   final diffHashMat = hconcat(colDiff, rowDiff);
//   print(diffHashMat.toList());
//   return diffHashMat
//       .toString()
//       .length; // TODO: this may not work, check `hash.data -> Uint8List`
// }
// }
